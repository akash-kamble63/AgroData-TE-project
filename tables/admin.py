...
from tables.models import Crop, Plot, Soil, Issue, Tool, plantationandharvesting
...
class plantationandharvestingAdmin(admin.ModelAdmin):
    list_display = ('user','datetime','location','plotid','cropid','dateofpreparation','dateofplantation','startofharvesting','endofharvesting','currentharvest','previousharvest','accumulatedharvest')
admin.site.register(plantationandharvesting, plantationandharvestingAdmin)