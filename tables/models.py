...
class plantationandharvesting(models.Model):
    user = models.ForeignKey(User, on_delete=models.CASCADE)
    datetime = models.DateTimeField(auto_now_add=True)
    location = models.CharField(max_length=60, blank=True)
    plotid = models.CharField(max_length=60, blank=True)
    cropid = models.CharField(max_length=60, blank=True)
    dateofpreparation = models.CharField(max_length=60, blank=True)
    dateofplantation = models.CharField(max_length=60, blank=True)
    startofharvesting = models.CharField(max_length=60, blank=True)
    endofharvesting = models.CharField(max_length=60, blank=True)
    currentharvest = models.CharField(max_length=60, blank=True)
    previousharvest = models.CharField(max_length=60, blank=True)
    accumulatedharvest = models.CharField(max_length=60, blank=True)